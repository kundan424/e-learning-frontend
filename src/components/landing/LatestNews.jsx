...
const sidebarNews = [
    {
        tag: 'PRESS RELEASE',
        tagColor: 'bg-AllInOneCloud-Blue',
    ...
    {
        tag: 'NEWS',
        tagColor: 'bg-AllInOneCloud-teal',
    ...
    return (
        <section className="py-16 md:py-24 px-6 lg:px-12" id="blog">
            <div className="max-w-7xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-semibold text-[#49BBBD] mb-2">
                    Lastest News and <span className="text-[#2F327D]">Resources</span>
                </h2>
                ...
                <div className="flex flex-col lg:flex-row gap-8 text-left">
                    ...
                    <div className="flex-1">
                        ...
                        <h3 className="text-lg font-semibold text-totc-navy mb-2 leading-snug">
                    ...
                    <div className="flex-1 space-y-5">
                        {sidebarNews.map((item, i) => (
                            <div key={i} className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="text-sm font-semibold text-totc-navy leading-snug mb-1">{item.title}</h4>
